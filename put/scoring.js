    ...
    if (role === "team") {
      ...
      if (scores.PEOPLE >= 6 || answerLog.some(function (a) { return a.optionId === "next"; })) {
        return {
          ...
          body: "Или хотя бы понимать, куда можно двигаться. Для команды мы собираем туры, мастер-классы, тренинги и выезды с единомышленниками — место, где можно расти рядом с другими.",
          softLine: "Мы знаем, как с этим работать.",
      ...
      if (growth) {
        return {
          ...
          body: "Дальше можно посмотреть мероприятия для ребят из линейки: мастер-классы, практики, выезды. Если захотите — оставьте контакт, напишем спокойно.",
          softLine: "Мы знаем, как с этим работать.",
          cta: "Смотреть туры и мастер-классы",
          ctaHref: "/tury/",
          secondaryCta: "Оставить контакт",
      ...
      return {
        ...
        body: "Даже спокойные ответы — это уже разговор с собой. Если захотите продолжить — загляните к турам и мастер-классам для команды.",
        softLine: "",
        cta: "Смотреть туры и мастер-классы",
        ctaHref: "/tury/",
        secondaryCta: "Оставить контакт",
